...
public class FriendListManager {
	...
	public void requestFriendAddition(String friendName) throws IOException {
		output.writeObject(new Message(friendName, ClientHandler.getNewFriendRequestCommand()));
	}
}
